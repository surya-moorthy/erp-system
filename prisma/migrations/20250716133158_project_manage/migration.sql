...
-- CreateIndex
CREATE UNIQUE INDEX "TaskAssignment_userId_cardId_key" ON "TaskAssignment"("userId", "cardId");
...
-- AddForeignKey
ALTER TABLE "TaskAssignment" ADD CONSTRAINT "TaskAssignment_cardId_fkey" FOREIGN KEY ("cardId") REFERENCES "Card"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
